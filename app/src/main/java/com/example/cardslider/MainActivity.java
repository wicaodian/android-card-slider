...
import lib.CardSliderLayoutManager;
import lib.CardSnapHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final int[] maps = {R.drawable.map_1, R.drawable.map_2, R.drawable.map_3, R.drawable.map_1, R.drawable.map_2};
